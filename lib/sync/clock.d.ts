 ...
 */
export declare function estimateOffset({ sendAt, serverTime, receiveAt }: OffsetSample): number;
/**
 ...
 */
export declare function elapsedAt(startedAt: number, now: number): number;
